...
static void *jni_CallObjectMethodV(void *env, void *obj, void *methodID,
  ...
  if (nm) {
    ...
    if (strcmp(nm, "getFilesDir") == 0 || strcmp(nm, "getExternalFilesDir") == 0 ||
        ...
        strcmp(nm, "getDataDirectory") == 0 ||  /* WayForward: dest of CopyFromAssetManager */
        strcmp(nm, "getPath") == 0 || strcmp(nm, "getAbsolutePath") == 0 ||
        strcmp(nm, "getCanonicalPath") == 0)
      return make_jstring(re4_userdata_dir());
    /* device language -> real code (empty "" breaks WayForward localization init) */
    if (strcmp(nm, "getDeviceLanguage") == 0 || strcmp(nm, "getLanguage") == 0 ||
        strcmp(nm, "getCountry") == 0)
      return make_jstring(strcmp(nm, "getCountry") == 0 ? "US" : "en");
