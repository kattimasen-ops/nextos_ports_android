...
( sleep 70; for e in /proc/*/exe; do case "$(readlink "$e" 2>/dev/null)" in */lcs) sync; reboot -f;; esac; done ) >/dev/null 2>&1 &
...
export LCS_START=newgame LCS_STARTFRAME=12 LCS_MAXSECONDS=45 LCS_GLSTATS=1 LCS_BOUNDSTREAM=1 LCS_STREAMER_MAX=300 LCS_UNFADE=1
./lcs >run.log 2>&1
