...
export LCS_START=newgame LCS_STARTFRAME=12 LCS_MAXSECONDS=26 LCS_GLSTATS=1 LCS_BOUNDSTREAM=1 LCS_STREAMER_MAX=80 LCS_UNFADE=1 LCS_NOPVSCULL=1 LCS_NOON=1 LCS_NODOFADE=1 LCS_NOPVS=0 LCS_OBFDIAG=1
./lcs >run.log 2>&1
